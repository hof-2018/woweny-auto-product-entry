...
public class EtsyRugEntryService {
    ...
    public void execute() throws InterruptedException {
        ...
        try {
            ...
            for (Product product : products) {
                ...
                //////////Section
                SeleniumUtils.selectFromElement(driver, "//*[@id=\"sections\"]", EtsyConstants.leafCategoryRugMap.get(product.getLeafCategory()));
                //////////Tags
    ...
    private String generateDescription(Product product) {
        ...
        description.append(StringUtils.LF).append(StringUtils.LF);
        description.append(EtsyConstants.RUG_DESCRIPTION);
